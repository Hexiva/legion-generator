$(document).ready(function() {
  ...
  $('#but').click(function(){
    ...
    if (charNum === 0) {
      var characters = ["Oliver Bird", "Kerry Loudermilk", "Cary Loudermilk", "Amahl Farouk", "Amy Haller", "David Haller", "Lenny Busker", "Melanie Bird", "Sydney Barett", "Ptonomy Wallace", "Clark DeBussy", "Dr. Poole", "The Narrator"];
